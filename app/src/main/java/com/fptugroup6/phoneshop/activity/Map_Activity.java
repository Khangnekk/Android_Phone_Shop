...
public class Map_Activity extends AppCompatActivity
    ...
    private static final String TAG = com.fptugroup6.phoneshop.activity.Map_Activity.class.getSimpleName();
    ...
    private final LatLng storeLocation = new LatLng(21.0138936, 105.5257671);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.option_get_place) {
            getStoreLocation();
        }if (item.getItemId() == R.id.option_main) {
